...
.mc-links { display:flex; gap:30px; font-size:14px; font-weight:700; } .mc-links button { appearance:none; -webkit-appearance:none; border:0; padding:0; margin:0; background:transparent; color:#60708e; font:inherit; cursor:pointer; transition:color .18s ease; } .mc-links button:hover { color:#2f6cf6; } .mc-links button:first-child { color:#2f6cf6; } #scanner, #how-to-use, #about { scroll-margin-top:24px; }
